    ...
    public static class Database
    {
        ...
        public static void Load<T>(this IDataReader rdr, T item, List<string> ColumnNames)
        {
            ...
            for (int i = 0; i < rdr.FieldCount; i++)
            {
                ...
                //if (currentField == null && columns != null)
                //{
                //    var singleColumn = columns.SingleOrDefault(x => x.Name.Equals(pName, StringComparison.InvariantCultureIgnoreCase));
                //    currentProp = cachedProps.SingleOrDefault(x => x.Name.Equals(singleColumn.CleanName, StringComparison.InvariantCultureIgnoreCase));
                //}
